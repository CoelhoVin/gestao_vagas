...
public class CandidateController {
    ...
    @PostMapping("/")
    @Operation(summary = "Cadastro de candidado", description = "Essa função é responsável por cadastrar um candidato")
    @ApiResponses({
    ...
    @Operation(summary = "Perifl do Candidato", description = "Essa função é responsável por buscar o perfil do canditato")
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
    ...
    @GetMapping("/job")
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(summary = "Listagem de vagas disponíveis para o candidado", description = "Essa função é responsável por listar todas as vagas disponíveis baseadas no filtro")
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
